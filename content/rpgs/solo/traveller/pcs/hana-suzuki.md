...
| --------------- | ---- | ------- | ----------- | ----- | ------ |
| Laser Pistol    | 11   | 30m     | 3D10+3      | 100   | -      |
...
| --------------- | -------------- | ---------------- | ----------------- | ---------- | -------- |
| 80,000CR            | -           | -            | -             | 12,000CR/year (pension)      | -    |

### Career
1. University, graduated, Overturned orthodoxy on veterinary practices and gained tutor as a rival
2. Marine (Support), survived, ranked up, joined the Jewell Duchy Marines as an officer, and was assigned to assault on enemy fortress on the home planet and was injured, advanced to Captain nonetheless
3. Marine (Support, rank Captain, survived, didn't rank up, assigned to assualt an enemy fortress on Esalin and was injured
4. Marine (Support), rank Captain, surived, didn't rank up, gained a new contact
